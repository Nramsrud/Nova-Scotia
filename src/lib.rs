...
use nova_snark::{
    ...
    PublicParams, RecursiveSNARK, parallel_prover,
};
...
//add a parallel prover pub params
pub fn create_parallel_public_params(r1cs: R1CS<F1>) -> parallel_prover::PublicParams<G1, G2, C1, C2> {
    ...
    parallel_prover::PublicParams::setup(circuit_primary.clone(), circuit_secondary.clone())
}
